//
//  ShowSeekerProfileTableViewController.swift
//  MobileProg
//
...
import UIKit
import Firebase
class ShowSeekerProfileTableViewController: UITableViewController {
    ...
    @IBAction func editClicked(_ sender: Any) {
        ...
        let vc = s.instantiateViewController(withIdentifier: "EditSeekerTableViewController") as! EditSeekerTableViewController
        vc.id = self.id
